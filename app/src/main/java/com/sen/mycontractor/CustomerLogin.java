...
public class CustomerLogin extends Activity implements LoaderCallbacks<Cursor> {
    ...
    private AutoCompleteTextView emailAutoTv;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        emailAutoTv = (AutoCompleteTextView) findViewById(R.id.emailAutoTv);
        ...
        Button mEmailSignInButton = (Button) findViewById(R.id.emailLoginBtn);
...
*/
    ...
    private void attemptLogin() {
        ...
        mUser = mAuth.getCurrentUser();
                    ...
                    //emailAutoTv.setError("Email does not exist!");


               // Toast.makeText(CustomerLogin.this, "Invalid email", Toast.LENGTH_SHORT).show();
