...
class MessagesFixtures extends FixturesData {
    ...
    public static Message getImageMessage() {
        Message message = new Message(getRandomId(),getRandomId(), getUser(), null);
    ...
    public static Message getTextMessage(String text) {
        return new Message(getRandomId(),getRandomId(), getUser(), text);
    }
