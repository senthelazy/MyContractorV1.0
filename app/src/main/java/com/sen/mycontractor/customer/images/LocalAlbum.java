...
public class LocalAlbum extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(com.sen.mycontractor.R.layout.local_album);
    ...
    View.OnClickListener onClickListener = new View.OnClickListener() {
        ...
        public void onClick(View view) {
            if (LocalImageHelper.getInstance().getCurrentSize() + LocalImageHelper.getInstance().getCheckedItems().size() >= 9) {
                Toast.makeText(LocalAlbum.this, "Up to 9 Photos", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            switch (requestCode) {
                case ImageUtils.REQUEST_CODE_GETIMAGE_BYCAMERA:
                    ...
                    if (StringUtils.isEmpty(cameraPath)) {
                        Toast.makeText(this, "Can't get photo", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    File file = new File(cameraPath);
                    if (file.exists()) {
    ...
    public class FolderAdapter extends BaseAdapter {
        ...
        public View getView(int i, View convertView, ViewGroup viewGroup) {
            ...
            if (convertView == null || convertView.getTag() == null) {
                ...
                convertView = LayoutInflater.from(context).inflate(R.layout.item_album_folder, null);
