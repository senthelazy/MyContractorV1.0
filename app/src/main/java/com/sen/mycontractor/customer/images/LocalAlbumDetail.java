package com.sen.mycontractor.customer.images;
...
import com.sen.mycontractor.common.AppManager;
import com.sen.mycontractor.common.BaseActivity;
...
/**
 * Created by Jessie on 2017-09-09.
 */
                    ...
                    public void run() {
                        if (folders != null) {
                            ...
                            if (checkedItems.size()+LocalImageHelper.getInstance().getCurrentSize() > 0) {
                                finish.setText("Confirm(" + (checkedItems.size()+"/"+LocalImageHelper.getInstance().getCurrentSize()) + "/9)");
                                finish.setEnabled(true);
                                headerFinish.setText("Confirm(" + (checkedItems.size()+"/"+LocalImageHelper.getInstance().getCurrentSize()) + "/9)");
                                headerFinish.setEnabled(true);
                            } else {
                                finish.setText("Confirm");
//                                finish.setEnabled(false);
                                headerFinish.setText("Confirm");
        ...
        if (!b) {
            ...
            if (!checkedItems.contains(compoundButton.getTag())) {
                if(checkedItems.size()+LocalImageHelper.getInstance().getCurrentSize()>=9){
                    Toast.makeText(this,"Up to 9 Photos",Toast.LENGTH_SHORT).show();
